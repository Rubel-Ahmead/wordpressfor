...
var upgradeBullets = [__('Generate impressive images that you can, edit, enhance and refine.', 'elementor'), __('Create professional text, about any topic, in any tone and language.', 'elementor'), __('Unleash infinite possibilities with the custom code generator.', 'elementor')];
